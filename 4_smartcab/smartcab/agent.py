...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing is True:
            ...
            #if self.t < 300:
            #    self.epsilon = 1 # Let the agent choose a random action to explore the world
            #else:
            a = 0.99
            self.epsilon *= a
    ...
    def createQ(self, state):
        ...
        if self.learning is True:
            self.Q[state] = self.Q.setdefault(state, {action:0.0 for action in self.valid_actions})
    ...
    def choose_action(self, state):
        ...
        if self.learning is False:
            ...
            if self.epsilon > random.random():
                ...
                for action_l in self.Q[state]:
                    if maxQ == self.Q[state][action_l]:
                        q_actions.append(action_l)
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=learning, alpha=alpha, epsilon=epsilon)
